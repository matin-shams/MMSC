    ...
    return conditional(  # If we're outside the vortex...
        ...
        conditional(  # If we're at the origin...
            ...
            conditional(  # If we're on the z axis...
                ...
                as_vector(  # Else...
                    hill_r(r_sph, theta, radius) * as_vector([x, y, z]) / r_sph
                  + hill_theta(r_sph, theta, radius) * as_vector([x*z, y*z, -r_cyl**2]) / r_sph / r_cyl
                  + hill_phi(r_sph, theta, radius) * as_vector([-y, x, 0]) / r_cyl
                )
            )
        )
    )
